...
class Speed_test_UI(QWidget):
    ...
    def __init__(self):
        ...
        self.label_1 = QLabel("Please wait after you click the 'start' button", self) #initilize the text label
        self.label_1.move(int(self.width()//5), int(self.height()//10)+50)
        self.initUI()
    """
    ...
    def show_speed(self):
        ...
        self.label_1.setText("Speed test finished") #change the text label
