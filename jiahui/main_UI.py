...
class main_UI(QWidget):
    ...
    def initUI(self):        
        ...
        btn2.setGeometry(scaled_pixmap.width() + temp_width,0,temp_width,scaled_pixmap.height())
        ...
        self.btn3.setGeometry(scaled_pixmap.width()//2 - buttonWidth//2, (self.height()-scaled_pixmap.height())//2 - buttonHeight//2 + scaled_pixmap.height(), buttonWidth, buttonHeight)
